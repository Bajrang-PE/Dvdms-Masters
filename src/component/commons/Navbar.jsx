...
export default function MastersNavbar({
  ...
  console.log('Selected ROw : ', dataTableRef?.current?.getSelectedRowsData());
  ...
  function activeForm() {
    switch (userSelection) {
      case 'Add':
        return <AddForm data={dataTableRef?.current?.getSelectedRowsData()} />;
      case 'Modify':
        return (
          <ModifyForm data={dataTableRef?.current?.getSelectedRowsData()} />
        );
      case 'View':
        return <ViewForm data={dataTableRef?.current?.getSelectedRowsData()} />;
    }
  }
