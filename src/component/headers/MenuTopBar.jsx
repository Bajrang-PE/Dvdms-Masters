...
import { FaBell, FaCog, FaKey, FaSignOutAlt, FaUser, FaUserCircle } from "react-icons/fa";
import { useNavigate } from 'react-router-dom';

const MenuTopBar = (props) => {
    const { title, subtitle, logoUrl, isLocation, isEmail, bg, isHelpDesk } = props;
    ...
    return (
        <>
            <header className={`shadow-lg border-b border-white/20 bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-200 to-red-400 to-lime-200 backdrop-blur-sm z-2 relative`}>
                <div className="mx-auto flex flex-col md:flex-row justify-between items-center px-3 py-2 space-y-3 md:space-y-0">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="leading-tight overflow-hidden">
                            <h5 className="text-white font-bold text-lg relative inline-block drop-shadow-lg">
                                <span className="text-white">
                                    {title}
                                </span>
                            </h5>
                            <p className="text-sm text-[#00369f] font-semibold drop-shadow-md">{subtitle}</p>
                        </div>
                    </div>
                    <div className="flex items-center space-x-2">
                        ...
                        <div className="relative" ref={notificationMenuRef}>
                            <button
                                className="flex items-center justify-center w-10 h-10 bg-white/20 backdrop-blur-sm border-2 border-white/50 hover:bg-white/30 hover:scale-110 group transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
                                ...
                                <div className="absolute right-0 mt-1 w-80 bg-white/95 backdrop-blur-lg rounded-xl shadow-2xl border border-white/20 overflow-hidden animate-in slide-in-from-top-5 duration-200 z-50">
                                    <div className="px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-yellow-50 to-orange-50">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-xs bg-orange-500 text-white px-2 py-1 rounded-full">3 New</span>
                                        </div>
                                    </div>
                        ...
                        <div className="relative" ref={userMenuRef} style={{ zIndex: 2 }}>
                            <button
                                className="flex items-center space-x-1 backdrop-blur-sm px-1 py-2  transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
                                style={{ borderRadius: "20%" }}
                            ...
                            {/* Dropdown Menu */}
                            {showUserMenu && (
                                <div className="absolute right-0 mt-1 w-64 bg-white/95 backdrop-blur-lg rounded-xl shadow-2xl border border-white/20 overflow-hidden animate-in slide-in-from-top-5 duration-200 z-50">
                                    {/* User Info */}
                                    <div className="px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-purple-50">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <span className="font-semibold text-gray-800">Bajrang Bali</span> <br />
                                                <span className="text-sm text-gray-600">bajrang@bali.com</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="py-2">
                                        <button
                                            className="flex items-center space-x-3 w-full px-4 py-2 text-left hover:bg-blue-50 transition-all duration-200 group relative overflow-hidden"
                                        >
                                            ...
                                            <span className="font-medium text-gray-800 group-hover:text-blue-600">User Settings</span>
                                        </button>

                                        <button
                                            className="flex items-center space-x-3 w-full px-4 py-2 text-left hover:bg-green-50 transition-all duration-200 group relative overflow-hidden"
                                        >
                                            ...
                                            <span className="font-medium text-gray-800 group-hover:text-green-600">Change Password</span>
                                        </button>
