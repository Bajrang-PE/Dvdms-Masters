...
const TopBar = (props) => {
    ...
    const HelpDesk = () => {
        const helpDeskData = [
            { name: "1. Priyanandan Prasad", designation: "Implementaion Manager", mobileNo: "+91 7992372001" },
            { name: "2. Swet Kamal", designation: "Implementation Engineer", mobileNo: "+91 8002365555" },
            { name: "3. Prakash Jaiswal", designation: "It-Cell Executive", mobileNo: "+91 8860289500" },
            { name: "4.Goury Datta Sharma", designation: "Data Entry Operator", mobileNo: "+91 9534848052" },
            { name: "5. Ganga Sharma", designation: "Data Entry Operator", mobileNo: "+91 8210744091" }
        ];

        return (
            <>
                <h3 className="text-2xl font-bold text-gray-800 mb-6 border-b pb-4 text-center">HELP DESK</h3>
    ...
    return (
        <>
            <header className={`shadow-md border-b border-gray-200`} style={{ backgroundColor: bg ? bg : "#34211973" }}>
                    ...
                    <div className="flex flex-col sm:flex-row items-center text-sm gap-4">
                        ...
                        {isHelpDesk &&
                            <div className="flex flex-col items-center text-center bg-white rounded-2">
                                <img className='cursor-pointer' src="/phone_jh.gif" alt="Help Desk" height="46" width="46" onClick={() => setShowModal(true)}></img>
                                {/* <span>Help Desk</span> */}
                            </div>
                        }
                    </div>
            ...
            {showModal &&
                <GlobalModal Data={HelpDesk} size={''} onClose={onClose} />
            }
        </>
    )
}
