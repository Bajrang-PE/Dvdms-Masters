        ...
        <nav className="bg-[#1e1f90] text-white text-sm font-medium">
            <div className="mx-auto px-4 py-2 flex items-center justify-between">
                ...
                <div className="flex items-center">
                    ...
                    <LoginPopup showLogin={showLogin} setShowLogin={setShowLogin} logoUrl={logoUrl} />
                </div>
            </div>
            ...
            {isOpen && (
                <div className="md:hidden px-4 pb-4 space-y-3">
                    ...
                    <NavLinks mobile onLinkClick={handleLinkClick} menuItems={menuItems} />
                </div>
            )}
        </nav>
    );
        ...
        <>
            {menuItems?.map(({ to, icon, label, id }) => (
                <Link
                    ...
                    onClick={() => { onLinkClick(); scrollToSection(id ? id : '') }}
                >
