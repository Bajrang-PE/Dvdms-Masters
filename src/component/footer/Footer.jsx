                ...
                <div className="flex flex-col lg:flex-row gap-4 items-start">
                    ...
                    <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 lg:w-2/5">
                        ...
                        <div className="text-center lg:text-left">
                            <h3 className="text-xl font-bold mb-1 animate-color-flow">AMSCL, Govt. of Assam</h3>
                            <h4 className="text-sm font-semibold text-blue-200 mb-6">DVDMS (e-Austradh)</h4>
