...
import { FaEnvelope, FaGlobe, FaSearchengin } from "react-icons/fa";
            ...
            <footer className="bg-gray-900 text-gray-300 pt-8 pb-2 px-8 md:px-16" id="contactjh">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
                    ...
                    <div>
                        ...
                        <span>S.D.A Complex Kasumpti Shimla-9</span> <br />
                        <span>Phone No:0177-2621424,Fax No:0177-2622307</span> <br />
                        {/* <span>Ranchi - 834010</span> <br /> */}
                        <a href="mailto:hpaushadi@gmail.com" className="!text-blue-100 !hover:text-white !transition-colors text-sm flex items-center" >
                            <FaEnvelope className="text-white-600 text-sm mr-2" />
                            hpaushadi@gmail.com
                        </a>

                        <a href="http://himachal.nic.in" className="!text-blue-100 !hover:text-white !transition-colors text-sm flex items-center" target="_blank">
                            <FaGlobe className="text-white-600 text-sm mr-2" />
